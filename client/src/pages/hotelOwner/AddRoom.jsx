    ...
    <form>
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
            ...
            <select  value={setInputs.roomType} onChange={e=> setInputs({...setInputs, roomType: e.target.value})} className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
        ...
        <div>
            ...
            <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24' value={setInputs.pricePerNight} onChange={e=> setInputs({...setInputs, pricePerNight: e.target.value})} />
        </div>
      </div>
